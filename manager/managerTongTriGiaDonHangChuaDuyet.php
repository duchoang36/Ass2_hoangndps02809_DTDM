...
$tongtiendonhang = mysql_query("SELECT SUM(tongtien) AS tongdoanhthu FROM donhang where (trangthaidh like 'chuaduyet') AND (ngaylapdh BETWEEN CAST('$ngaybatdau' AS DATE) 

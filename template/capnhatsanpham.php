...
<table border="0" cellpadding="0" cellspacing="0" bordercolor="#0069A8" width="100%">
	<tbody>
	   <tr>
    	...
    	<td>
   		<table border="0" cellpadding="2" bordercolor="#111111" width="100%" cellspacing="0">
			...
			<tr>
				...
				<tr><td height="10px"></td></tr>
				<tr>
					<td width="15%"   align="right">soluong</td>
					<td width="1%"   align="center"></td>
					<td width="83%"  >
        ...
        <tr><td height="10px"></td></tr>
				<tr>
					<td width="15%"   align="right">Khong hien thi</td>
					<td width="1%"   align="center"></td>
					<td width="83%"  >
            ...
            <select name="matheloai">
              <option value="1" <?php echo $matheloai==1? 'selected'?>><?php echo $matheloai?>Iphone</option>

...
where sanpham.matheloai = theloai.matheloai and sanpham.maqt = quantri.maqt and sanpham.trangthaisp = 1 and theloai.tentheloai like 'Apple TV' ") or die(mysql_error());

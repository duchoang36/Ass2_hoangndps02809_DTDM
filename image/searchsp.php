												...
												<form  action="" method="post" enctype="multipart/form-data">
													<table>
														<tr>
															...
															<th><a href="searchkh.php"><input href="searchkh.php" type="submit" class="btn btn-primary" value="SEARCH" name="search"/></a></th>
														</tr>
                            tr>
															<th><input type="text" class="form-control" placeholder="tim theo mã KH" name="masp"/></th>
															<th><a href="searchkh.php"><input href="searchkh.php" type="submit" class="btn btn-primary" value="SEARCH" name="searchkh"/></a></th>
														</tr>
													</table>
												</form>

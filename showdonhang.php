...
$query  = "SELECT * FROM donhang
          INNER JOIN khachhang ON khachhang.makh = donhang.makh Where donhang.trangthaidh = 'dangchoduyet'  ORDER BY donhang.madh DESC";//You don't need a ; like you do in SQL

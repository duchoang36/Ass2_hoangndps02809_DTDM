            ...
            <table border="0" cellpadding="0" cellspacing="0" bordercolor="#0069A8" width="100%">
						<tr>
								<tbody>
									...
									<td><img src="<?php echo $hinhanh;?>" style="width:120px;height=120px"/></td>
								</tbody>
	...
	<tbody>
	   <tr>
        ...
        <tr>
					...
					<td width="70%"  >
            <select name="maqt">
              <option value="1" <?php echo $maqt==1? 'selected':''?>>Thiet</option>
              <option value="2" <?php echo $maqt==2? 'selected':''?>>Hoa</option>
              <option value="3" <?php echo $maqt==3? 'selected':''?>>Hoang</option>
              <option value="4" <?php echo $maqt==4? 'selected':''?>>Hao</option>
            </select>
					</td>
				</tr>
				<tr><td height="10px"></td></tr>
